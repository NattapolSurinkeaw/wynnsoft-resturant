...
function NewOrderModal({ isOpenNewOrderModal, closeModal }) {
  ...
  return (
    isOpenNewOrderModal && (
      <div className="fixed inset-0 bg-black/60 bg-opacity-50 flex items-center justify-center z-20">
        ...
        {activeTab === 1 && (
          <div className="relative bg-white p-4 rounded-lg shadow-lg w-[480px]">
            ...
            <div className="flex gap-4 w-full">
              <figure className="max-w-[130px] h-[130px] shadow-md">
                <img
              ...
              <div className="flex flex-col justify-between w-full">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-4 ">
                    ...
                    <p className="text-[#00537B] text-[26px] font-[600]">2</p>
            ...
            <div className="w-full text-[#313131] text-[16px] font-[400] h-[100px] bg-[#EEEEEE] rounded-md p-2 mt-6">
              ไม่ใส่หอม ไม่เค็ม ไม่มัน ผัดน้ำแทนน้ำมัน เพิ่มหน่อไม้สด
            </div>
        ...
        {/* Tab 2 */}
        {activeTab === 2 && (
          <div className="relative bg-white p-4 rounded-lg shadow-lg w-[580px]">
            <button
              ...
              <div className="flex w-full justify-between">
                <div>
                  ...
                  <p className="text-[16px] text-[#313131] font-[400]">
                    ไม่ใส่หอม ไม่เค็ม ไม่มัน ผัดน้ำแทนน้ำมัน เพิ่มหน่อไม้ สด
                  </p>
                </div>
                <p className="text-[18px] text-[#313131] font-[400]">
                  1 <span className="ml-2">รายการ</span>
                </p>
              </div>
            </div>
            ...
            <div className="mb-2">
              <div className="flex justify-between">
                <p className="w-[220px] text-black text-[16px] font-[500] mt-4">
                  เต้าหู้ไข่ & หมูสับผัด กระเทียมพริกไทย
                </p>
                <p className="text-black text-[16px] font-[500] mt-4">120</p>
              </div>
              <p className="text-black text-[15px] font-[500] mt-1 underline decoration-1">
                หมายเหตุ
              </p>
              <p className="text-black text-[15px] font-[300]">
                ไม่ใส่หอม ไม่เค็ม ไม่มัน ผัดน้ำแทนน้ำมัน เพิ่ม หน่อไม้สด
              </p>
            </div>
            <div className="mb-2">
              <div className="flex justify-between">
